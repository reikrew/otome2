...
screen say(who, what):
    ...
    if not renpy.variant("small"): 
        add SideImage() xalign 0.0 zoom 1.1 yalign 1.0
...
screen main_menu():
    ...
    ## Posicionamiento absoluto de los botones según tu diseño
    
    # CONTRATO - Posición superior central
    imagebutton:
    ...
    # CONTINUAR (CARGAR) - Segunda posición
    imagebutton:
    ...
    # PERSONAJES - Cuarta posición
    imagebutton:
        auto "menuUI/character_gallery_%s.png"
        action ShowMenu("character_gallery")
        xalign 0.5
        ypos 620
        
    # AYUDA - Quinta posición
    imagebutton:
    ...
    # RENUNCIAR (SALIR) - Sexta posición
    imagebutton:
